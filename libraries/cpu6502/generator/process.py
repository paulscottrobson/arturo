...
#		Absolute modes
#
modes["a"] = { "eac":"FETCH16();eac = temp16;", "cycles":0, "desc":"@2" }
modes["ax"] = { "eac":"FETCH16();eac = (temp16+x) & 0xFFFF;", "cycles":0, "desc":"@2,X" }
modes["ay"] = { "eac":"FETCH16();eac = (temp16+y) & 0xFFFF;", "cycles":0, "desc":"@2,Y" }
#
#		Zero Page modes
#
...
#		Indirect mode.
#
modes["id"] = { "eac":"FETCH16();eac = READ16(temp16);", "cycles":2, "desc":"(@2)" }
...
modes["iax"] = { "eac":"FETCH16();temp16 = (temp16+x) & 0xFFFF;eac = READ16(temp16)","cycles":2,"desc":"(@2,x)"}
#
#		BBS/BBR mode.
#
